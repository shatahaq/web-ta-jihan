...
final class TagihanController extends Controller
{
    ...
    public function store(): void
    {
        ...
        try { (new Tagihan())->create($data); Session::flash('toast', ['type' => 'success', 'message' => 'Tagihan berhasil ditambahkan.']); redirect('/tagihan'); }
    ...
    public function update(string $id): void
    {
        ...
        try { (new Tagihan())->update((int) $id, $data); Session::flash('toast', ['type' => 'success', 'message' => 'Tagihan berhasil diperbarui.']); redirect('/tagihan'); }
